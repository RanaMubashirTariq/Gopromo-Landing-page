          ...
          <div className="flex items-start w-full justify-between gap-14 max-[1000px]:flex-wrap max-[450px]:gap-10">
            <div className="flex items-start gap-12 max-[1300px]:gap-10 max-[1000px]:flex-wrap max-[450px]:gap-6">
              ...
              <div className="flex flex-col items-start gap-4">
                <div className="flex flex-col items-start gap-4">
                  <h3 className="[font-family:'Plus_Jakarta_Display-Regular',Helvetica] font-normal text-[#f4263e] text-base text-right tracking-[-0.16px] leading-[22px] whitespace-nowrap">
                    Company
                  </h3>
                  ...
                  {companyLinks.map((link, index) => (
                    <a
                      key={index}
                      href={link.href}
                      className="[font-family:'Plus_Jakarta_Display-Regular',Helvetica] font-normal text-neutral-colors500 text-base text-right tracking-[-0.16px] leading-[22px] whitespace-nowrap"
                    >
                      {link.title}
                    </a>
                  ))}
